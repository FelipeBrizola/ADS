...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.print("D: ");
		System.out.printf("%.2f", s.getFlow());
		System.out.print(" cl/h \n");
		
		System.out.print("U: ");
		System.out.printf("%.2f", s.getUtilization());
		System.out.print("% \n");
		
		System.out.print("N: ");
		System.out.printf("%.2f", s.getPopulation());
		System.out.print(" cl \n");
		
		System.out.print("W: ");
		System.out.printf("%.2f", s.getResponseTime());
		System.out.println();
